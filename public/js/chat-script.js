document.addEventListener('DOMContentLoaded', function() {
    ...
    const apiKey = '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';
    ...
    async function fetchAIResponse(messages) {
        const requestBody = {
            ...
            messages: messages,
            temperature: 0.6, // Ajustado según recomendaciones del modelo
            max_tokens: 800,
            top_p: 0.95, // Ajustado según recomendaciones del modelo
